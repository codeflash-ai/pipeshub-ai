...
_KNOWLEDGE_BASE_VAL = Connectors.KNOWLEDGE_BASE.value

_RECORD_GROUPS_VAL = CollectionNames.RECORD_GROUPS.value
...
class BaseArangoService:
    ...
    async def get_knowledge_base_by_id(
        ...
        try:
            ...
            cursor = db.aql.execute(query, bind_vars={
                "kb_id": kb_id,
                "@recordGroups_collection": _RECORD_GROUPS_VAL,
                "kb_type": _KNOWLEDGE_BASE_VAL,
                "kb_connector": _KNOWLEDGE_BASE_VAL,
            })
