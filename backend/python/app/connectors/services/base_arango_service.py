...
class BaseArangoService:
    ...
    async def get_sync_point(self, key: str, collection: str, transaction: Optional[TransactionDatabase] = None) -> Optional[Dict]:
        ...
        """
        try:
            # Combine logger messages that appear consecutively, and only log when necessary to reduce cost
            query = (
            ...
            if result is not None:
                # Delay expensive log str formatting using lazy logging, pass %s and key as args
