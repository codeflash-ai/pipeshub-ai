    ...
    async def drive_manual_sync_control(self, action: str, org_id: str) -> dict:
        ...
        try:
            ...
            if action == "start":
                ...
                # Yield to the event loop for other tasks to observe _stop_requested quickly,
                # but do not unnecessarily block for 2s; reduces unnecessary latency
                await asyncio.sleep(0)
                self.logger.info("🚀 Yielded to event loop for sync service pause")
