...
class HTTPClient(IClient):
    ...
    async def execute(self, request: HTTPRequest, **kwargs) -> HTTPResponse:
        ...
        """
        # Avoid dict interpolation for path_params if already empty
        ...
        # Merge client headers with request headers (request headers take precedence), optimized for single header
