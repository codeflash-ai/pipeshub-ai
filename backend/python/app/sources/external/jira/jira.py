...
Path params:
  - taskId (str)"""
        ...
        # Optimized URL formatting for fixed pattern
        url = f"{self.base_url}/rest/api/3/bulk/queue/{taskId}"
        # Precompute str dicts for path and query (almost no-op, but required for API compliance)
...
def _as_str_dict(d: Dict[str, Any]) -> Dict[str, str]:
    # If already {str: str}, avoid dict copying and value conversion
