...
Query params:
  ...
  - maxResults (int, optional)
  - expand (str, optional)"""
        # Local bindings to reduce attribute lookup overhead
        _client = self._client
        base_url = self.base_url
        if _client is None:
            raise ValueError('HTTP client is not initialized')
        # Build headers and path/query as efficiently as possible
        ...
        # Await the I/O as soon as possible; no batching available in this context
