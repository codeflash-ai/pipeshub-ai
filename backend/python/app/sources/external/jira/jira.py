...
# Memoized empty dict/string-dict constants for high-frequency use
...
class JiraDataSource:
    def __init__(self, client: JiraClient) -> None:
        ...
        # Memoize these if base_url is fixed; else can be moved to get_events if variable
        self._empty_path_params = _EMPTY_STR_DICT
        self._empty_query_params = _EMPTY_STR_DICT
...
HTTP GET /rest/api/3/events"""
        ...
        req = HTTPRequest(
            ...
            url=url,
            headers=_as_str_dict(_headers),
            path_params=self._empty_path_params,
            query_params=self._empty_query_params,
            body=None,
        )
        resp = await self._client.execute(req)
        return resp
...
def _as_str_dict(d: Dict[str, Any]) -> Dict[str, str]:
    ...
    # Short-circuit for empty dicts to avoid unnecessary call/iteration/allocation
    if not d:
