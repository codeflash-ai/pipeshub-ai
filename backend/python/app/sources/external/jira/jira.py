...
Body (application/json) fields:
  ...
  - type (str, required)"""
        ...
        # Optimization: _path and _query always {}, so don't call _as_str_dict or allocate useless dicts.
        req = HTTPRequest(method='POST', url=url, headers=_as_str_dict(_headers), path_params={}, query_params={}, body=_body)
        resp = await self._client.execute(req)
        return resp
