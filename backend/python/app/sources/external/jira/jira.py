...
Query params:
  ...
  - projectId (list[int], required)"""
        ...
        req = HTTPRequest(method='GET', url=url, headers=_as_str_dict(_headers) if _headers else {}, path_params={}, query_params=_as_str_dict(_query), body=_body)
        resp = await self._client.execute(req)
        return resp
