...
Body (application/json) fields:
  ...
  - name (str, required)"""
        ...
        _path: Dict[str, Any] = _EMPTY_DICT  # never mutated
        _query: Dict[str, Any] = _EMPTY_DICT  # never mutated
        _body: Dict[str, Any] = {}
        if description is not None:
            _body['description'] = description
        _body['name'] = name
...
def _safe_format_url(template: str, params: Dict[str, object]) -> str:
    # Avoid template formatting if params is empty or template has no braces
...
def _as_str_dict(d: Dict[str, Any]) -> Dict[str, str]:
    ...
    # Avoids unnecessary dict allocation for empty dicts
    if not d:
