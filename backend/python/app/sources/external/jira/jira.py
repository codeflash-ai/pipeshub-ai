...
Query params:
  - expand (str, optional)"""
        ...
        # For static rel_path and empty _path, skip formatting and use rel_path directly
...
def _as_str_dict(d: Dict[str, Any]) -> Dict[str, str]:
    # Optimization: avoid comprehension if dict is empty
    if not d:
        return {}
    sv = _serialize_value
    sk = str
    return {sk(k): sv(v) for k, v in d.items()}
