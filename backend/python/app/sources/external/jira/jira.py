...
# _SafeDict for format_map, minimal local definition if needed
...
Path params:
  - id (str)"""
        ...
        # Optimize _as_str_dict on fixed path/query/body
        req = HTTPRequest(
            method='GET',
            url=url,
            headers=_as_str_dict(_headers),
            path_params={'id': id},  # since 'id' is already str
