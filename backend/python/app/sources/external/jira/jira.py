...
# Constant for reuse of empty stringified dicts for params
...
Body (application/json) fields:
  ...
  - validateQuery (str, optional)"""
        ...
        req = HTTPRequest(method='POST', url=url, headers=_as_str_dict(_headers), path_params=_EMPTY_STR_DICT, query_params=_EMPTY_STR_DICT, body=_body)
        resp = await self._client.execute(req)
        return resp
...
def _as_str_dict(d: Dict[str, Any]) -> Dict[str, str]:
    # Inline the most common empty case for speed
    if not d:
