...
Body (application/json) fields:
  ...
  - startAt (int, optional)"""
        ...
        # Efficient default header handling
        if headers is None:
        ...
        joined_url = self.base_url + _safe_format_url(rel_path, _path)
        req = HTTPRequest(
            method='POST',
            url=joined_url,
...
def _safe_format_url(template: str, params: Dict[str, object]) -> str:
    # Avoid unnecessary formatting if no params
    if not params:
        return template
    try:
