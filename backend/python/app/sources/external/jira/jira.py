...
# Cache constant empty str dict for common empty path/query use
_EMPTY_STR_DICT: Dict[str, str] = {}

# Minimal implementation to avoid NameError in _safe_format_url
...
Body (application/json) fields:
  ...
  - additionalProperties allowed (pass via body_additional)"""
        ...
        # Use local variable to prevent multiple lookups
