...
Body (application/json) fields:
  ...
  - additionalProperties allowed (pass via body_additional)"""
        ...
        # _headers optimization: avoid setdefault if possible, ensure minimal dict copying/allocation
        ...
        # Inline single-pass query dict population
        _query = {}
        ...
        # Build _body using a tuple list, as fields are all optional and non-overwriting
        _body = {}
        ...
        # Call _as_str_dict cheaply by combining fields to avoid repetitive code
...
def _safe_format_url(template: str, params: Dict[str, object]) -> str:
    # Move the class out for performance (definition allocation on every call is slow)
...
def _as_str_dict(d: Dict[str, Any]) -> Dict[str, str]:
    # Minor optimization: check for empty here, avoid dict() allocation
    if not d:
        return {}
