...
_REL_PATH_EVENTS = '/rest/api/3/events'
...
HTTP GET /rest/api/3/events"""
        ...
        url = f"{self.base_url}{_REL_PATH_EVENTS}"
        _headers_str = _as_str_dict(_headers) if _headers else _EMPTY_DICT
        req = HTTPRequest(method='GET', url=url, headers=_headers_str, path_params=_EMPTY_DICT, query_params=_EMPTY_DICT, body=None)
        resp = await self._client.execute(req)
        return resp
