...
def _as_str_dict(d: Dict[str, Any]) -> Dict[str, str]:
    # Fast-path: empty/None dict returns empty dict reference
    if not d:
        return {}
    # If keys are already strings (likely), skip unnecessary str()
    # Batch conversion outside dictionary comprehension for type stability
    out = {}
    for k, v in d.items():
