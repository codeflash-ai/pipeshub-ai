...
Path params:
  ...
  - notificationId (str)"""
        ...
        _path = {'notificationSchemeId': notificationSchemeId, 'notificationId': notificationId}
        _str_path = _as_str_dict(_path)
        url = self.base_url + _safe_format_url('/rest/api/3/notificationscheme/{notificationSchemeId}/notification/{notificationId}', _path)
        req = HTTPRequest(
            method='DELETE',
            url=url,
            headers=_headers,
