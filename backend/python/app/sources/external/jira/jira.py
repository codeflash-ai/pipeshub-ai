...
Query params:
  ...
  - properties (list[str], optional)"""
        ...
        # Header copy optimized for None case
        _headers: Dict[str, Any] = dict(headers) if headers is not None else {}

        # Build _query dict in a single pass for better memory & speed
        _query: Dict[str, Any] = {}
        if expand is not None:
            _query['expand'] = expand
        ...
        # Avoids extra string concat by formatting url in place
        ...
        req = HTTPRequest(
            ...
            path_params={},  # always empty dict, direct assignment
...
def _as_str_dict(d: Dict[str, Any]) -> Dict[str, str]:
    # Avoid dict comprehension overhead for large dicts by explicit loop
    out = {}
    for k, v in d.items():
