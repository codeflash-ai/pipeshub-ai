...
HTTP GET /rest/api/3/license/approximateLicenseCount"""
        ...
        req = HTTPRequest(method='GET', url=url, headers=_as_str_dict(_headers) if _headers else _EMPTY_STR_DICT, path_params=_EMPTY_STR_DICT, query_params=_EMPTY_STR_DICT, body=_body)
        resp = await self._client.execute(req)
        return resp
